          ...
          <div class="col-md-12">
            ...
            <div class="VerticalTab VerticalTab_hash_scroll VerticalTab_6 tabs_ver_6">
              ...
              <ul class="resp-tabs-list hor_1">
                ...
                <li class="tabs-1" data-tab-name="login"><span class="tabs-text">Login</span></li>
                      ...
                      <div class="col-md-6">
                        <div class="left-content">
                          ...
                          <div class="primary-button">
                            ...
                            <a href="registration.php">Zaregistrovať</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="contact-form">
                          ...
                          <form id="contact" action="spojenie.php" method="post">
                            <fieldset>
